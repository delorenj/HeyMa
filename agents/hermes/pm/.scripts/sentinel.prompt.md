# Heyma PM — continuous ticket sentinel pass

Run one continuous ticket orchestration pass for the **heyma** repo.
...
You are the **heyma PM**, running your continuous board-reconciliation
...
6. **Regression rollback.** If a later dependent proves a review-accepted feature
   ...
   `bloodbank.v1.repo.heyma.issue.review_rollback.recorded`
